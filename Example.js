...
function setupCertificatePinning() {
	Przelewy24Payment.setCertificatePinningEnabled(certificatePinningEnabled);
}
...
switch(Platform.OS){
	...
	doTrnRequest = async function() {
				...
				Przelewy24Payment.startTrnRequestWithParams(
					trnRequestParams,
	...
	doTrnDirect = async function () {
				...
				Przelewy24Payment.startTrnDirectWithParams(trnDirectParams,
					(success, cancel, error) => {
						if (success) {
							console.log("Transfer success");
						} else if(cancel) {
	...
	doExpress = async function () {
				...
				Przelewy24Payment.startExpressWithParams(expressParams,
					(success, cancel, error) => {
					if (success) {
						console.log("Transfer success");
					} else if(cancel) {
